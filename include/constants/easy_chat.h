...
#define EC_WORD_JEALOUSY        (EC_GROUP_STATUS << 9) | 0x1
#define EC_WORD_ICE_WALL     (EC_GROUP_STATUS << 9) | 0x2
#define EC_WORD_RAIN_DISH     (EC_GROUP_STATUS << 9) | 0x3
#define EC_WORD_DRIZZLE       (EC_GROUP_STATUS << 9) | 0x4
#define EC_WORD_SHADOW_TAG    (EC_GROUP_STATUS << 9) | 0x5
...
#define EC_WORD_HISOUTEN      (EC_GROUP_STATUS << 9) | 0xd
#define EC_WORD_PSYCHIC       (EC_GROUP_STATUS << 9) | 0xe
#define EC_WORD_UNNATURAL_STRENGTH  (EC_GROUP_STATUS << 9) | 0xf
#define EC_WORD_FIGHTING      (EC_GROUP_STATUS << 9) | 0x10
#define EC_WORD_DARK_TAG    (EC_GROUP_STATUS << 9) | 0x11
...
#define EC_WORD_GUARD_ARMOR  (EC_GROUP_STATUS << 9) | 0x17
...
#define EC_WORD_GATE_KEEPER  (EC_GROUP_STATUS << 9) | 0x1b
#define EC_WORD_GRASS         (EC_GROUP_STATUS << 9) | 0x1c
#define EC_WORD_HAKUREI_MIKO    (EC_GROUP_STATUS << 9) | 0x1d
...
#define EC_WORD_DOLL_WALL    (EC_GROUP_STATUS << 9) | 0x22
...
#define EC_WORD_BARRIER   (EC_GROUP_STATUS << 9) | 0x29
...
#define EC_WORD_MAINTENANCE     (EC_GROUP_STATUS << 9) | 0x35
#define EC_WORD_UNZAN    (EC_GROUP_STATUS << 9) | 0x36
...
#define EC_WORD_POISON_BODY  (EC_GROUP_STATUS << 9) | 0x3d
...
#define EC_WORD_FRETFUL        (EC_GROUP_STATUS << 9) | 0x41
#define EC_WORD_RUN_AWAY      (EC_GROUP_STATUS << 9) | 0x42
#define EC_WORD_COLLECTOR   (EC_GROUP_STATUS << 9) | 0x43
#define EC_WORD_UNCONSCIOUS    (EC_GROUP_STATUS << 9) | 0x44
#define EC_WORD_NORMAL        (EC_GROUP_STATUS << 9) | 0x45
#define EC_WORD_STEEL         (EC_GROUP_STATUS << 9) | 0x46
#define EC_WORD_DIVA    (EC_GROUP_STATUS << 9) | 0x47
...
#define EC_WORD_FOCUS  (EC_GROUP_STATUS << 9) | 0x4e
#define EC_WORD_SPRING_CHARM  (EC_GROUP_STATUS << 9) | 0x4f
#define EC_WORD_PLAY_GHOST  (EC_GROUP_STATUS << 9) | 0x50
...
#define EC_WORD_STRANGE_MIST   (EC_GROUP_STATUS << 9) | 0x55
#define EC_WORD_MYSTERIOUS  (EC_GROUP_STATUS << 9) | 0x56
#define EC_WORD_SOUNDPROOF    (EC_GROUP_STATUS << 9) | 0x57
#define EC_WORD_INFECTIOUS  (EC_GROUP_STATUS << 9) | 0x58
...
#define EC_WORD_FIRE_VEIL   (EC_GROUP_STATUS << 9) | 0x5e
...
#define EC_WORD_INNER_POWER         (EC_GROUP_STATUS << 9) | 0x62
...
#define EC_WORD_ADVENT   (EC_GROUP_STATUS << 9) | 0x6c
