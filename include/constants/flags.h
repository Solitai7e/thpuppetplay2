...
#define FLAG_SPAWN_INVISIBLE                 0x54  // If TRUE, the player is invisible; When you want the player to appear again, you must use the applymovement command that includes a set_visible movement command
...
#define FLAG_MET_CHARGE_BEAM_GIVER          0x76
...
#define FLAG_MOVE_TUTOR_TAUGHT_TREMORS       0x1B2
...
#define FLAG_MOVE_TUTOR_TAUGHT_HEAD_SMASH   0x1B9
...
#define FLAG_HIDE_DEWFORD_HALL_GUNK_SHOT_MAN                      0x3AC
