...
extern const u8 BattleScript_GuardStoringEnergy[];
extern const u8 BattleScript_GuardAttack[];
extern const u8 BattleScript_GuardNoEnergyToAttack[];
...
extern const u8 BattleScript_MonWokenUpByPerformance[];
...
extern const u8 BattleScript_PrintPerformanceOverTurns[];
...
extern const u8 BattleScript_MoveEffectPerformance[];
...
extern const u8 BattleScript_MaintenanceActivates[];
...
extern const u8 BattleScript_CollectorActivates[];
extern const u8 BattleScript_MysteriousActivates[];
extern const u8 BattleScript_DollWallActivates[];
