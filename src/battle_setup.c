...
{
    [TRANSITION_TYPE_ILLUSION] = {B_TRANSITION_SLICE,          B_TRANSITION_WHITE_BARS_FADE},
...
{
    [TRANSITION_TYPE_ILLUSION] = {B_TRANSITION_POKEBALLS_TRAIL, B_TRANSITION_ANGLED_WIPES},
...
static u8 GetBattleTransitionTypeByMap(void)
{
    ...
    if (!MetatileBehavior_IsSurfableWaterOrUnderwater(tileBehavior))
    {
        ...
        default:
            return TRANSITION_TYPE_ILLUSION;
        }
    }
    return TRANSITION_TYPE_WATER;
}
