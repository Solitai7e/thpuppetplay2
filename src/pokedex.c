...
{
    {gText_DexEmptyString, gText_DexSearchDontSpecify},
    [SOURCE_HRTP   + 1]  = {gText_DexEmptyString, gText_DexSearchSourceHRTP},
    [SOURCE_SOEW   + 1]  = {gText_DexEmptyString, gText_DexSearchSourceSOEW},
    [SOURCE_PODD   + 1]  = {gText_DexEmptyString, gText_DexSearchSourcePODD},
    [SOURCE_LLS    + 1]  = {gText_DexEmptyString, gText_DexSearchSourceLLS},
    [SOURCE_MS     + 1]  = {gText_DexEmptyString, gText_DexSearchSourceMS},
    [SOURCE_EOSD   + 1]  = {gText_DexEmptyString, gText_DexSearchSourceEOSD},
    [SOURCE_PCB    + 1]  = {gText_DexEmptyString, gText_DexSearchSourcePCB},
    [SOURCE_IN     + 1]  = {gText_DexEmptyString, gText_DexSearchSourceIN},
    [SOURCE_POFV   + 1]  = {gText_DexEmptyString, gText_DexSearchSourcePOFV},
    [SOURCE_MOF    + 1]  = {gText_DexEmptyString, gText_DexSearchSourceMOF},
    [SOURCE_SA     + 1]  = {gText_DexEmptyString, gText_DexSearchSourceSA},
    [SOURCE_UFO    + 1]  = {gText_DexEmptyString, gText_DexSearchSourceUFO},
    [SOURCE_TD     + 1]  = {gText_DexEmptyString, gText_DexSearchSourceTD},
    [SOURCE_DDC    + 1]  = {gText_DexEmptyString, gText_DexSearchSourceDDC},
    [SOURCE_LOLK   + 1]  = {gText_DexEmptyString, gText_DexSearchSourceLOLK},
    [SOURCE_HSIFS  + 1]  = {gText_DexEmptyString, gText_DexSearchSourceHSIFS},
    [SOURCE_WBAWC  + 1]  = {gText_DexEmptyString, gText_DexSearchSourceWBAWC},
    [SOURCE_UM     + 1]  = {gText_DexEmptyString, gText_DexSearchSourceUM},
    [SOURCE_SPINOFF+ 1]  = {gText_DexEmptyString, gText_DexSearchSourceSPINOFF},
    [SOURCE_PRINT  + 1]  = {gText_DexEmptyString, gText_DexSearchSourcePRINT},
	[SOURCE_OTHER  + 1]  = {gText_DexEmptyString, gText_DexSearchSourceOTHER},
    {},
};
...
static int DoPokedexSearch(u8 dexMode, u8 order, u8 abcGroup, u8 sourceGame, u8 type1, u8 type2)
{
    ...
    if (sourceGame != 0xFF)
    {
        for (i = 0, resultsCount = 0; i < sPokedexView->pokemonListCount; i++)
        {
            ...
            if (sourceGame == gBaseStats[species].sourceGame)
            {
                sPokedexView->pokedexList[resultsCount] = sPokedexView->pokedexList[i];
                resultsCount++;
            }
