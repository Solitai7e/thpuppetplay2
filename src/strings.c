...
const u8 gText_Pokedex[] = _("Touhoudex"); // Unused
...
const u8 gText_PokedexRegistration[] = _("Touhoudex registration completed.");
...
const u8 gText_SwitchPokedexListings[] = _("Switch Touhoudex listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the Touhoudex.");
const u8 gText_SelectPokedexMode[] = _("Select the Touhoudex mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select the Touhoudex listing mode.");
...
const u8 gText_DexHoennDescription[] = _("HOENN region's Touhoudex");
const u8 gText_DexNatDescription[] = _("National edition Touhoudex");
...
const u8 gText_HOFDexRating[] = _("Spotted Puppets: {STR_VAR_1}!\nOwned Puppets: {STR_VAR_2}!\pPROF. BIRCH's Puppet rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_SomeonesPC[] = _("Someone's Gap");
const u8 gText_LanettesPC[] = _("Yukari's Gap");
const u8 gText_PlayersPC[] = _("{PLAYER}'s Gap");
...
const u8 gPCText_Withdraw[] = _("Take Out");
const u8 gPCText_Shift[] = _("Swap");
...
const u8 gText_SeeYa[] = _("Sayonara!");
const u8 gText_WithdrawMonDescription[] = _("Move puppet stored in boxes to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store puppets in your party in boxes.");
const u8 gText_MoveMonDescription[] = _("Organize the puppet in boxes and\nin your party.");
...
const u8 gText_DrainPunch24BP[] = _("Drain Punch{CLEAR_TO 0x4E}24BP");
const u8 gText_GigaImpact48BP[] = _("Giga Impact{CLEAR_TO 0x4E}48BP");
const u8 gText_BodySlam48BP[] = _("BODY SLAM{CLEAR_TO 0x4E}48BP");
const u8 gText_RockWrecker48BP[] = _("ROCK WRECKER{CLEAR_TO 0x4E}48BP");
...
const u8 gText_MudShot24BP[] = _("MUD-SHOT{CLEAR_TO 0x4E}24BP");
...
const u8 gText_PkmnFainted3[] = _("{STR_VAR_1} got through the poisoning.\nThe poison faded away!\p");
...
const u8 gText_ContinueMenuPokedex[] = _("Touhoudex");
...
const u8 gText_BattleStyle[] = _("Puppet Shifting");
const u8 gText_Sound[] = _("Audio Channels");
const u8 gText_Frame[] = _("Window Frame");
const u8 gText_OptionMenuCancel[] = _("Cancel");
const u8 gText_ButtonMode[] = _("Shoulder Buttons");
...
const u8 gText_ButtonTypeLR[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Default");
...
const u8 gText_SavingPokedex[] = _("Touhoudex");
