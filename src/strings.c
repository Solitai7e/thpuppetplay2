...
// = _("Highly Responsive to Prayers");
// = _("Story of Eastern Wonderland");
// = _("Phantasmagoria of Dim.Dream");
// = _("Lotus Land Story");
// = _("Mystic Square");
// = _("Embodiment of Scarlet Devil");
// = _("Perfect Cherry Blossom");
// = _("Imperishable Night");
// = _("Phantasmagoria of Flower View");
// = _("Mountain of Faith");
// = _("Subterranean Animism");
// = _("Undefined Fantastic Object");
// = _("Ten Desires");
// = _("Double Dealing Character");
// = _("Legacy of Lunatic Kingdom");
// = _("Hidden Star in Four Seasons");
// = _("Wily Beast and Weakest Creature");
// = _("Unconnected Marketeers");
// = _("Spinoff Games");
// = _("Print Works");
// = _("Other");
