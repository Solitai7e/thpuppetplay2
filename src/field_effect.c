...
static const u8 sRockFragment_TopLeft[] = INCBIN_U8("graphics/misc/gomaseki_rock_fragment_top_left.4bpp");
static const u8 sRockFragment_TopRight[] = INCBIN_U8("graphics/misc/gomaseki_rock_fragment_top_right.4bpp");
static const u8 sRockFragment_BottomLeft[] = INCBIN_U8("graphics/misc/gomaseki_rock_fragment_bottom_left.4bpp");
static const u8 sRockFragment_BottomRight[] = INCBIN_U8("graphics/misc/gomaseki_rock_fragment_bottom_right.4bpp");
...
void (*const sDestroyGomasekiRockEffectFuncs[])(s16*, u8) = {
