...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_ADMYSTIA,    .jumpType = JUMP_TYPE_ILLUSION, },
    ...
    { .species = SPECIES_ADMOKOU,   .jumpType = JUMP_TYPE_ILLUSION, },
...
static const u16 sSoundEffects[MAX_RFU_PLAYERS - 1] = {SE_SHOP, SE_SHINY, SE_M_ENERGY_LIGHT, SE_RG_POKE_JUMP_SUCCESS};
