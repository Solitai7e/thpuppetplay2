...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_CLILYWHITE,   .jumpType = JUMP_TYPE_ILLUSION, },
    ...
    { .species = SPECIES_CCIRNO,    .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_CRUMIA,  .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_SHANGHAI,  .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_HOURAI,  .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_CYUKARI,   .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_CSUIKA,     .jumpType = JUMP_TYPE_ILLUSION, },
    ...
    { .species = SPECIES_CCHEN,     .jumpType = JUMP_TYPE_ILLUSION, },
    ...
    { .species = SPECIES_CLAYLA,     .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_KEDAMA,      .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_CNUE,      .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_CMARISA,    .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CREIMU,     .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_GENJI,  .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_CELLY,  .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_ORANGE,   .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_KAZAMI,   .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CLUIZE,      .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_LUIZE,     .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_CMARGATROID,  .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_MARGATROID,     .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_HAKUREI,     .jumpType = JUMP_TYPE_ILLUSION, },
    ...
    { .species = SPECIES_AMOKOU,   .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_TSAKUYA,    .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_SRUMIA,  .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_AMYSTIA,     .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_TCHEN,     .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_DTENSHI,   .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_AKOISHI,     .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_DBYAKUREN,   .jumpType = JUMP_TYPE_ILLUSION, },
    ...
    { .species = SPECIES_DREIMU,     .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_SCIRNO,  .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_DYUYUKO,  .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_HLUNASA,  .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_HMERLIN,    .jumpType = JUMP_TYPE_ILLUSION, },
    ...
    { .species = SPECIES_TENMA,      .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_SENDAI,     .jumpType = JUMP_TYPE_ILLUSION, },
    ...
    { .species = SPECIES_SMARISA,    .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_CSHINGYOKU,    .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_ASUNNYMILK,     .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_ADVMYSTIA,    .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_TKISUME,     .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_ADVTEWI,       .jumpType = JUMP_TYPE_FAST, },
    ...
    { .species = SPECIES_YUKI,    .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_ADVMOKOU,   .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_ADVREISEN,    .jumpType = JUMP_TYPE_SLOW, },
    ...
    { .species = SPECIES_ALILYBLACK,     .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_DMINORIKO,   .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_ANUE,     .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_ADVCHEN,    .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_AMINORIKO,     .jumpType = JUMP_TYPE_ILLUSION, },
    { .species = SPECIES_DPATCHOULI,    .jumpType = JUMP_TYPE_ILLUSION, },
...
{
    [JUMP_TYPE_ILLUSION] = { -3,  -6,  -8, -10, -13, -15, -17, -19,
                          -21, -23, -25, -27, -28, -29,
...
static void LoadPokeJumpGfx(void)
{
    ...
    case 0:
        ...
        LoadPalette(sCAlice_Pal, 0x30, 0x20);
