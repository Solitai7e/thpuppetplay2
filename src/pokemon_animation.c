...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_REYSEN]    = BACK_ANIM_H_VIBRATE,
    ...
    [SPECIES_GENJI]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    ...
    [SPECIES_MIMI]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    ...
    [SPECIES_ADVMYSTIA]    = BACK_ANIM_H_VIBRATE,
    ...
    [SPECIES_MAGAN]   = BACK_ANIM_SHAKE_GLOW_RED,
    ...
    [SPECIES_ADVCIRNO]   = BACK_ANIM_H_VIBRATE,
    [SPECIES_ADVREISEN]    = BACK_ANIM_SHAKE_GLOW_GREEN,
    ...
    [SPECIES_ADVMEILING]     = BACK_ANIM_V_STRETCH,
    ...
    [SPECIES_ADVMARISA]     = BACK_ANIM_V_SHAKE,
    [SPECIES_ADVALICE]     = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_TSANAE]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_YUKI]    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ADVMOKOU]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ADVYUKARI]     = BACK_ANIM_H_STRETCH,
    [SPECIES_ADVRAN]    = BACK_ANIM_V_STRETCH,
    [SPECIES_ADVCHEN]    = BACK_ANIM_TRIANGLE_DOWN,
