...
const struct CompressedSpriteSheet gBattleAnimPicTable[] =
{
    ...
    {gBattleAnimSpriteGfx_BindingVoiceWaves, 0x0400, ANIM_TAG_BINDING_VOICE_WAVES},
    {gBattleAnimSpriteGfx_FlyingDirt, 0x0200, ANIM_TAG_FLYING_DIRT},
    {gBattleAnimSpriteGfx_IceShard, 0x0200, ANIM_TAG_ICE_SHARD},
...
const struct CompressedSpritePalette gBattleAnimPaletteTable[] =
{
    ...
    {gBattleAnimSpritePal_BindingVoiceWaves, ANIM_TAG_BINDING_VOICE_WAVES},
    {gBattleAnimSpritePal_FlyingDirt, ANIM_TAG_FLYING_DIRT},
    {gBattleAnimSpritePal_IceShard, ANIM_TAG_ICE_SHARD},
...
const struct BattleAnimBackground gBattleAnimBackgroundTable[] =
{
    ...
    [BG_JUDGEMENT_OPPONENT] = {gBattleAnimBgImage_Judgement, gBattleAnimBgPalette_Judgement, gBattleAnimBgTilemap_JudgementOpponent},
    [BG_JUDGEMENT_PLAYER]   = {gBattleAnimBgImage_Judgement, gBattleAnimBgPalette_Judgement, gBattleAnimBgTilemap_JudgementPlayer},
    [BG_JUDGEMENT_CONTESTS] = {gBattleAnimBgImage_Judgement, gBattleAnimBgPalette_Judgement, gBattleAnimBgTilemap_JudgementContests},
