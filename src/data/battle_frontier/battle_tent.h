...
const u16 gSlateportBattleTentTrainerMons_Davion[] =
{
    SLATEPORT_TENT_MON_HKOAKUMA,
    SLATEPORT_TENT_MON_CMERLIN,
    SLATEPORT_TENT_MON_ADTEWI_1,
    SLATEPORT_TENT_MON_ADTEWI_2,
...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [SLATEPORT_TENT_TRAINER_MAGGIE] = {
        ...
        .speechBefore = {EC_POKEMON(CSUIKA), EC_POKEMON(CHAKUREI), EC_POKEMON_NATIONAL(KURUMI), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_WORD_ELLIPSIS},
        .speechWin = {EC_POKEMON(CELIS), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON(TSATORI), EC_WORD_EXCL, -1},
        .speechLose = {EC_POKEMON(CELIS), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON_NATIONAL(BYAKUREN), EC_WORD_ELLIPSIS, EC_WORD_UH_OH},
...
const struct FacilityMon gSlateportBattleTentMons[NUM_SLATEPORT_TENT_MONS] =
{
    ...
    [SLATEPORT_TENT_MON_CMERLIN] = {
        ...
        .moves = {MOVE_DISCHARGE, MOVE_TREMORS, MOVE_CHARGE, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_ASHIKIEIKI_2] = {
        .species = SPECIES_ASHIKIEIKI,
        .moves = {MOVE_DISCHARGE, MOVE_CHARGE, MOVE_ROAR, MOVE_THUNDER_WAVE},
...
const struct FacilityMon gVerdanturfBattleTentMons[NUM_VERDANTURF_TENT_MONS] =
{
    ...
    [VERDANTURF_TENT_MON_TMEDICINE] = {
        .species = SPECIES_TMEDICINE,
        .moves = {MOVE_CONFUSION, MOVE_LUNATIC, MOVE_PROTECT, MOVE_FLASH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SILVER_POWDER,
    ...
    [VERDANTURF_TENT_MON_DIKU] = {
        .species = SPECIES_DIKU,
        .moves = {MOVE_REFRESH, MOVE_SAFEGUARD, MOVE_ATTRACT, MOVE_FALSE_SWIPE},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MILD
    },
...
{
    FALLARBOR_TENT_MON_ADTEWI_1,
    FALLARBOR_TENT_MON_ADTEWI_2,
...
const struct FacilityMon gFallarborBattleTentMons[NUM_FALLARBOR_TENT_MONS] =
{
    ...
    [FALLARBOR_TENT_MON_CMERLIN] = {
        .species = SPECIES_CMERLIN,
        .moves = {MOVE_CHARGE, MOVE_DISCHARGE, MOVE_SCREECH, MOVE_SONIC_BOOM},
        .itemTableId = BATTLE_FRONTIER_ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
