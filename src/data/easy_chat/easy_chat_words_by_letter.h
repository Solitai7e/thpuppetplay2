...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    EC_MOVE(BITE),
    EC_MOVE2(BLAST_BURN),
    EC_POKEMON(CLILYBLACK),
    EC_WORD_BLAZE,
    EC_MOVE2(BLAZE_KICK),
    EC_WORD_BLEND,
    EC_POKEMON(SHINGYOKUM),
    EC_MOVE2(BLIZZARD),
    EC_MOVE2(BLOCK),
    EC_WORD_BOARD,
    EC_MOVE2(BODY_SLAM),
...
const u16 gEasyChatWordsByLetter_S[] = {
    ...
    EC_WORD_SPORTS,
    EC_WORD_SPRING,
    EC_POKEMON(CLILYWHITE),
    EC_WORD_STAGE,
    EC_POKEMON(TBYAKUREN),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(YUUKA),
    EC_WORD_START,
    DOUBLE_SPECIES_NAME
