...
static const u16 sMoves_ImpossibleToPredict[] =
{
    ...
    MOVE_PRESENT, MOVE_DISTURBANCE, MOVE_TRICK, MOVE_RECOLLECTION, MOVE_ASSIST, MOVE_SKILL_SWAP, MOVE_CAMOUFLAGE,
    MOVE_NONE
};
...
static const u16 sMoves_SlowAndSteady[] =
{
    ...
    MOVE_THUNDER_WAVE, MOVE_TOXIC, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY, MOVE_GLARE, MOVE_OMINOUS_WIND, MOVE_LOVELY_KISS, MOVE_BURN_POWDER,
